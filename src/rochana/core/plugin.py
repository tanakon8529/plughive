...
A "plug" is a self-contained capability under src/rochana/plugs/<name>/ with a
...
drop a folder + list it in config/rochana.yaml. That's the "dynamic scaling".
"""
...
if TYPE_CHECKING:
    ...
    from rochana.brain.claude_cli import ClaudeBrain
    from rochana.brain.persona import PersonaLoader
    from rochana.config import Settings
